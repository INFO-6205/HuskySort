...
public class SelectionSortTimer {
    ...
    public static void calculateTime(final String text, final Integer[] input) {
        ...
        final ComparableSortHelper<Integer> helper = (ComparableSortHelper<Integer>) HelperFactory.create("Selection Sort", N, config);
        SelectionSort<Integer> s = new SelectionSort<>(helper);
        s.init(N);
        ...
        final Benchmark<Integer[]> benchmark_timer = new Benchmark<>("Selection Sort", re);
    ...
    public static void main(String[] args) {
        final List<Integer[]> randomNumbersList = Lists.newArrayList(
                ...
                generateRandomNumberArray(102400)
        );

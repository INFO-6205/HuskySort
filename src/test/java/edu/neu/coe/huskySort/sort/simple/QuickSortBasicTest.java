...
public class QuickSortBasicTest {
    ...
    public void testPartitionWithSort() {
        ...
        int n = xs.length;
        final Config config = ConfigTest.setupConfig("true", "0", "1", "", "");
        final InstrumentedComparisonSortHelper<String> helper = new InstrumentedComparisonSortHelper<>("test", config);
        ...
        QuickSort_Basic<String> sorter = new QuickSort_Basic<>(helper);
